...
const HowToPlay = () => {
  return (
    <div className="grid gap-10 lg:grid-cols-3">
      <div className="relative flex w-full max-w-lg flex-col items-center justify-center rounded-lg bg-zinc-800 px-5 py-12">
        <span className="absolute top-2 left-2 flex h-10 w-10 items-center justify-center rounded bg-zinc-700 text-sm font-semibold">
          1
        </span>

...
const ChatMoves = () => {
  ...
  const setShowModal = useModalStore((state) => state.setModal);
  ...
  return (
    <div className="h-full">
      <p className="mb-5 flex pl-5 pr-[26px] font-medium text-white lg:pl-10 lg:pr-[46px]">
        ...
        <button
          className="ml-auto flex h-[22px] w-[22px] cursor-pointer items-center justify-center rounded-full bg-zinc-800 text-sm hover:bg-zinc-700"
          onClick={() => setShowModal("howToMove")}
        >
          <svg
